...
struct {
    ...
    std::optional<std::string> valueToMode(FastChargeMode mode) const {
        switch (mode) {
            case FastChargeMode::NONE: return valueNone;
            case FastChargeMode::FAST_CHARGE: return valueFastCharge;
            case FastChargeMode::SUPER_FAST_CHARGE: return valueSuperFastCharge;
            default: return {};
        }
    }
