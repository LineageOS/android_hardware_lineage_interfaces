...
#define VIBRATOR_AMPLITUDE "vendor.lineage.vibrator.amplitude."
#define LIGHT              "light"
...
Return<int8_t> Vibrator::getDefaultIntensity() {
    return defaultIntensity;
}

Return<int8_t> Vibrator::getIntensity(getIntensity_cb _hidl_cb) {
    return intensity;
}
