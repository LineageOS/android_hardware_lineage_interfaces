...
ndk::ScopedAStatus PowerShare::isEnabled(bool* out_enabled) {
    ...
    *out_enabled = Trim(value) == POWERSHARE_ENABLED;
    return ndk::ScopedAStatus::ok();
}

// Enable and disable powershare.
ndk::ScopedAStatus PowerShare::setEnabled(bool in_enable) {
    std::string value = in_enable ? POWERSHARE_ENABLED : POWERSHARE_DISABLED;
