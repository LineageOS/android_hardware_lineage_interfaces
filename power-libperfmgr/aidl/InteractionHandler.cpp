...
static const std::array<const char *, 3> kDispIdlePath = {
        "/sys/class/drm/card0/device/idle_state", "/sys/class/graphics/fb0/idle_state",
...
template class InteractionHandler<::android::perfmgr::HintManager>;
