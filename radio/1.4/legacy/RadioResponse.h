...
struct RadioResponse : public V1_4::IRadioResponse {
  public:
    ...
    // Helper methods
    void setRealRadioResponse(sp<V1_0::IRadioResponse> realRadioResponse);

    bool getDataRoaming();
    V1_0::RadioTechnology getRadioTechnology();

  private:
    sp<V1_0::IRadioResponse> mRealRadioResponse;

    bool mDataRoaming = false;
    V1_0::RadioTechnology mRadioTechnology = V1_0::RadioTechnology::UNKNOWN;

    sp<V1_1::IRadioResponse> getRealRadioResponse_V1_1();
    sp<V1_2::IRadioResponse> getRealRadioResponse_V1_2();
    sp<V1_3::IRadioResponse> getRealRadioResponse_V1_3();
    sp<V1_4::IRadioResponse> getRealRadioResponse_V1_4();
};
