...
struct Radio : public V1_4::IRadio {
  public:
    Radio(sp<::android::hardware::radio::V1_0::IRadio> realRadio);
    ...
    Return<void> setPreferredNetworkTypeBitmap(
            ...
            override;
    Return<void> setAllowedCarriers_1_4(
            int32_t serial,
  ...
  private:
    sp<::android::hardware::radio::V1_0::IRadio> mRealRadio;

    sp<::android::hardware::radio::V1_0::IRadioResponse> mRealRadioResponse;
    sp<::android::hardware::radio::V1_0::IRadioIndication> mRealRadioIndication;

    RadioResponse mRadioResponse;
    RadioIndication mRadioIndication;

    sp<::android::hardware::radio::V1_1::IRadio> getRealRadio_V1_1();
    sp<::android::hardware::radio::V1_2::IRadio> getRealRadio_V1_2();
    sp<::android::hardware::radio::V1_3::IRadio> getRealRadio_V1_3();
    sp<::android::hardware::radio::V1_4::IRadio> getRealRadio_V1_4();
};
