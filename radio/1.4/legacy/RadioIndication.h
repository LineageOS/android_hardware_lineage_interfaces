...
struct RadioIndication : public V1_4::IRadioIndication {
  public:
    ...
    // Helper methods
    void setRealRadioIndication(sp<V1_0::IRadioIndication> realRadioIndication);

  private:
    sp<V1_0::IRadioIndication> mRealRadioIndication;

    sp<V1_1::IRadioIndication> getRealRadioIndication_V1_1();
    sp<V1_2::IRadioIndication> getRealRadioIndication_V1_2();
    sp<V1_3::IRadioIndication> getRealRadioIndication_V1_3();
    sp<V1_4::IRadioIndication> getRealRadioIndication_V1_4();
};
