...
Return<void> RadioConfig::getPhoneCapability(int32_t serial) {
    ...
    ::android::hardware::radio::V1_0::RadioResponseInfo radioResponseInfo = {
...
Return<void> RadioConfig::setPreferredDataModem(int32_t serial, uint8_t modemId) {
    std::vector<sp<::android::hardware::radio::V1_0::IRadio>> radios;
    ...
    ::android::hardware::radio::V1_0::RadioError radioError =
            ::android::hardware::radio::V1_0::RadioError::NONE;

    if (radios.empty() || modemId >= radios.size()) {
        radioError = ::android::hardware::radio::V1_0::RadioError::INVALID_ARGUMENTS;
    } else {
...
sp<::android::hardware::radio::V1_0::IRadio> RadioConfig::getRadioForModemId(uint8_t modemId) {
    if (mModemIdToRadioCache.find(modemId) == mModemIdToRadioCache.end()) {
        mModemIdToRadioCache[modemId] = ::android::hardware::radio::V1_0::IRadio::getService(
                "slot" + std::to_string(modemId + 1));
    }
...
::android::hardware::radio::V1_0::RadioResponseInfo RadioConfig::getUnimplementedResponseInfo(
        int32_t serial) {
    return {
            ::android::hardware::radio::V1_0::RadioResponseType::SOLICITED,
            serial,
