...
#include <aidl/vendor/lineage/chgctrl/BnCharger.h>
#include <aidl/vendor/lineage/chgctrl/ChargerPauseType.h>
...
struct Charger : public BnCharger {
    ...
    ndk::ScopedAStatus getChargingPauseReasion(int32_t* _aidl_return) override;
