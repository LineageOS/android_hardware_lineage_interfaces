...
using ::vendor::lineage::livedisplay::V2_0::AdaptiveBacklight;
using ::vendor::lineage::livedisplay::V2_0::IColorBalance;
using ::vendor::lineage::livedisplay::V2_0::ColorBalance;
using ::vendor::lineage::livedisplay::V2_0::IDisplayModes;
using ::vendor::lineage::livedisplay::V2_0::DisplayModes;
using ::vendor::lineage::livedisplay::V2_0::IPictureAdjustment;
using ::vendor::lineage::livedisplay::V2_0::PictureAdjustment;
using ::vendor::lineage::livedisplay::V2_0::ISunlightEnhancement;
using ::vendor::lineage::livedisplay::V2_0::SunlightEnhancement;
...
int main() {
    ...
    sp<IPictureAdjustment> pa = new PictureAdjustment();
    if (pa == nullptr) {
        LOG(ERROR) << "Can not create an instance of LiveDisplay HAL PictureAdjustment Iface, exiting.";
        goto shutdown;
    }

    sp<ISunlightEnhancement> se = new SunlightEnhancement();
    if (se == nullptr) {
