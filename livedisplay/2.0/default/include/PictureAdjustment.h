...
class PictureAdjustment : public IPictureAdjustment {
  public:
    PictureAdjustment(sp<Color> colorImpl);
    ...
    Return<void> getAdjustment(getAdjustment_cb _hidl_cb) override;
    Return<void> getDefaultAdjustment(getDefaultAdjustment_cb _hidl_cb) override;
    Return<bool> setAdjustment(const HSIC& hsic) override;
