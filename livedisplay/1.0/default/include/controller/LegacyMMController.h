...
class LegacyMMController {
  public:
    ...
    int32_t get_num_display_modes(int32_t disp_id, int32_t mode_type, int32_t* mode_cnt);
    ...
    int32_t supported(int32_t disp_id, int32_t feature_id);
  ...
  private:
    ...
    typedef int32_t (*disp_api_get_num_display_modes)(int32_t, int32_t, int32_t*);
    ...
    typedef int32_t (*disp_api_supported)(int32_t, int32_t);
