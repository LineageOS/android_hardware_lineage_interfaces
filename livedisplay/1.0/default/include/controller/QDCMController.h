...
#ifndef VENDOR_LINEAGE_LIVEDISPLAY_V1_0_QDCMCONTROLLER_H
#define VENDOR_LINEAGE_LIVEDISPLAY_V1_0_QDCMCONTROLLER_H
...
public:
    static QDCMController& getInstance();
    ...
    int32_t get_global_color_balance(uint64_t hctx, uint32_t disp_id, int32_t *warmness,
                                            uint32_t *flags);
    int32_t get_num_display_modes(uint64_t hctx, uint32_t disp_id,
                                            uint32_t mode_type, int32_t *mode_cnt,
                                            uint32_t *flags);
    int32_t get_display_modes(uint64_t hctx, uint32_t disp_id, uint32_t mode_type,
    ...
    int32_t get_global_pa_config(uint64_t hctx, uint32_t disp_id, uint32_t *enable,
                                            void *cfg);
    int32_t set_global_pa_config(uint64_t hctx, uint32_t disp_id, uint32_t enable,
                                            void *cfg);
    int32_t get_feature_version(uint64_t hctx, uint32_t feature_id,
...
private:
    ...
    typedef int32_t (*disp_api_get_num_display_modes)(uint64_t, uint32_t, int32_t, int32_t*, uint32_t*);
    typedef int32_t (*disp_api_get_display_modes)(uint64_t, uint32_t, int32_t, void*, int32_t, uint32_t*);
    typedef int32_t (*disp_api_get_active_display_mode)(uint64_t, uint32_t, int32_t*, uint32_t*, uint32_t*);
...
#endif // VENDOR_LINEAGE_LIVEDISPLAY_V1_0_QDCMCONTROLLER_H
