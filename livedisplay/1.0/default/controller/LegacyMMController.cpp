...
int32_t LegacyMMController::get_num_display_modes(int32_t disp_id, int32_t mode_type, int32_t* mode_cnt) {
    CONTROLLER_CHECK(get_num_display_modes, disp_id, mode_type, mode_cnt);
}

int32_t LegacyMMController::get_display_modes(int32_t disp_id, int32_t mode_type, void* modes, int32_t mode_cnt) {
    CONTROLLER_CHECK(get_display_modes, disp_id, mode_type, modes, mode_cnt);
}

int32_t LegacyMMController::get_active_display_mode(int32_t disp_id, int32_t* mode_id, uint32_t* mask) {
...
int32_t LegacyMMController::supported(int32_t disp_id, int32_t feature_id) {
