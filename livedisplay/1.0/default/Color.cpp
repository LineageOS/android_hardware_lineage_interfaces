...
Color::Color() : mConnected(false), mBackend(NULL) {
    mBackend = new SDM();
...
Return<void> Color::native_getDisplayModes(native_getDisplayModes_cb _hidl_cb) {
...
Return<void> Color::native_getCurrentDisplayMode(native_getCurrentDisplayMode_cb _hidl_cb) {
    DisplayMode mode;
    Mutex::Autolock _l(mLock);
...
Return<void> Color::native_getDefaultDisplayMode(native_getDefaultDisplayMode_cb _hidl_cb) {
    DisplayMode mode;
    Mutex::Autolock _l(mLock);
...
Return<bool> Color::native_setDisplayMode(int32_t modeID, bool makeDefault) {
    status_t rc = NO_INIT;
    Mutex::Autolock _l(mLock);
...
Return<bool> Color::native_setAdaptiveBacklightEnabled(bool enabled) {
    status_t rc = NO_INIT;
    Mutex::Autolock _l(mLock);
...
Return<bool> Color::native_isAdaptiveBacklightEnabled() {
    Mutex::Autolock _l(mLock);
...
Return<bool> Color::native_setOutdoorModeEnabled(bool enabled) {
    status_t rc = NO_INIT;
    Mutex::Autolock _l(mLock);
...
Return<bool> Color::native_isOutdoorModeEnabled() {
    Mutex::Autolock _l(mLock);
...
Return<void> Color::native_getColorBalanceRange(native_getColorBalanceRange_cb _hidl_cb) {
    Range range;
    Mutex::Autolock _l(mLock);
...
Return<int32_t> Color::native_getColorBalance() {
    Mutex::Autolock _l(mLock);
...
Return<bool> Color::native_setColorBalance(int32_t value) {
    status_t rc = NO_INIT;
    Mutex::Autolock _l(mLock);
...
Return<bool> Color::native_setPictureAdjustment(const HSIC& hsic) {
    status_t rc = NO_INIT;
    Mutex::Autolock _l(mLock);
...
Return<void> Color::native_getPictureAdjustment(native_getPictureAdjustment_cb _hidl_cb) {
    HSIC hsic;
    Mutex::Autolock _l(mLock);
...
Return<void> Color::native_getDefaultPictureAdjustment(native_getDefaultPictureAdjustment_cb _hidl_cb) {
    HSIC hsic;
    Mutex::Autolock _l(mLock);
...
Return<void> Color::native_getHueRange(native_getHueRange_cb _hidl_cb) {
    HSICRanges ranges;
    Mutex::Autolock _l(mLock);
...
Return<void> Color::native_getSaturationRange(native_getSaturationRange_cb _hidl_cb) {
    HSICRanges ranges;
    Mutex::Autolock _l(mLock);
...
Return<void> Color::native_getIntensityRange(native_getIntensityRange_cb _hidl_cb) {
    HSICRanges ranges;
    Mutex::Autolock _l(mLock);
...
Return<void> Color::native_getContrastRange(native_getContrastRange_cb _hidl_cb) {
    HSICRanges ranges;
    Mutex::Autolock _l(mLock);
...
Return<void> Color::native_getSaturationThresholdRange(native_getSaturationThresholdRange_cb _hidl_cb) {
    HSICRanges ranges;
    Mutex::Autolock _l(mLock);
