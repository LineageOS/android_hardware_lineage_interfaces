...
Return<int32_t> SDMColor::deinit(int64_t hctx, uint32_t flags)
{
    if (disp_api_deinit == NULL) {
        return NO_INIT;
    }
...
Return<void> SDMColor::getGlobalColorBalanceRange(int64_t hctx, uint32_t disp_id,
...
Return<int32_t> SDMColor::setGlobalColorBalance(int64_t hctx, uint32_t disp_id, int32_t warmness, uint32_t flags)
{
    if (disp_api_set_global_color_balance == NULL) {
        return NO_INIT;
    }
...
Return<void> SDMColor::getGlobalColorBalance(int64_t hctx, uint32_t disp_id,
...
Return<void> SDMColor::getNumDisplayModes(int64_t hctx, uint32_t disp_id, int32_t mode_type,
...
Return<void> SDMColor::getDisplayModes(int64_t hctx, uint32_t disp_id, int32_t mode_type, int32_t mode_cnt,
...
Return<void> SDMColor::getActiveDisplayMode(int64_t hctx, uint32_t disp_id,
...
Return<int32_t> SDMColor::setActiveDisplayMode(int64_t hctx, uint32_t disp_id, int32_t mode_id, uint32_t flags)
{
    if (disp_api_set_active_display_mode == NULL) {
        return NO_INIT;
    }
...
Return<void> SDMColor::getDefaultDisplayMode(int64_t hctx, uint32_t disp_id,
...
Return<int32_t> SDMColor::setDefaultDisplayMode(int64_t hctx, uint32_t disp_id, int32_t mode_id, uint32_t flags)
{
    if (disp_api_set_default_display_mode == NULL) {
        return NO_INIT;
    }
...
Return<void> SDMColor::getGlobalPARange(int64_t hctx, uint32_t disp_id,
...
Return<void> SDMColor::getGlobalPAConfig(int64_t hctx, uint32_t disp_id,
...
Return<int32_t> SDMColor::setGlobalPAConfig(int64_t hctx, uint32_t disp_id,
...
Return<void> SDMColor::getFeatureVersion(int64_t hctx, uint32_t feature_id,
