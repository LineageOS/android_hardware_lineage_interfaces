...
struct SDMColor : public IColor
{
    ...
    Return<int32_t> deinit(uint32_t flags) override;
    Return<void> getGlobalColorBalanceRange(getGlobalColorBalanceRange_cb _hidl_cb) override;
    Return<int32_t> setGlobalColorBalance(int32_t warmness, uint32_t flags) override;
    Return<void> getGlobalColorBalance(getGlobalColorBalance_cb _hidl_cb) override;
    Return<void> getNumDisplayModes(int32_t mode_type,
                                    getNumDisplayModes_cb _hidl_cb) override;
    Return<void> getDisplayModes(int32_t mode_type, int32_t mode_cnt,
                                 getDisplayModes_cb _hidl_cb) override;
    Return<void> getActiveDisplayMode(getActiveDisplayMode_cb _hidl_cb) override;
    Return<int32_t> setActiveDisplayMode(int32_t mode_id, uint32_t flags) override;
    Return<void> getDefaultDisplayMode(getDefaultDisplayMode_cb _hidl_cb) override;
    Return<int32_t> setDefaultDisplayMode(int32_t mode_id, uint32_t flags) override;
    Return<void> getGlobalPARange(getGlobalPARange_cb _hidl_cb) override;
    Return<void> getGlobalPAConfig(getGlobalPAConfig_cb _hidl_cb) override;
    Return<int32_t> setGlobalPAConfig(uint32_t enable, const disp_pa_config& cfg) override;
    Return<void> getFeatureVersion(uint32_t feature_id,
