...
ndk::ScopedAStatus PictureAdjustment::getHueRange(FloatRange* _aidl_return) {
    ...
    *_aidl_return = FloatRange{};
    _aidl_return->max = r.hue.max;
    _aidl_return->min = r.hue.min;
    _aidl_return->step = r.hue.step;
...
ndk::ScopedAStatus PictureAdjustment::getSaturationRange(FloatRange* _aidl_return) {
    ...
    *_aidl_return = FloatRange{};
    _aidl_return->max = r.saturation.max;
    _aidl_return->min = r.saturation.min;
    _aidl_return->step = r.saturation.step;
...
ndk::ScopedAStatus PictureAdjustment::getIntensityRange(FloatRange* _aidl_return) {
    ...
    *_aidl_return = FloatRange{};
    _aidl_return->max = r.intensity.max;
    _aidl_return->min = r.intensity.min;
    _aidl_return->step = r.intensity.step;
...
ndk::ScopedAStatus PictureAdjustment::getContrastRange(FloatRange* _aidl_return) {
    ...
    *_aidl_return = FloatRange{};
    _aidl_return->max = r.contrast.max;
    _aidl_return->min = r.contrast.min;
    _aidl_return->step = r.contrast.step;
...
ndk::ScopedAStatus PictureAdjustment::getSaturationThresholdRange(FloatRange* _aidl_return) {
    ...
    *_aidl_return = FloatRange{};
    _aidl_return->max = r.saturation_threshold.max;
    _aidl_return->min = r.saturation_threshold.min;
    _aidl_return->step = r.saturation_threshold.step;
