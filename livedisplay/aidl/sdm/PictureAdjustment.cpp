...
ndk::ScopedAStatus PictureAdjustment::setPictureAdjustment(const HSIC& in_hsic,
                                                           bool* _aidl_return) {
    HsicConfig config = {0,
                         {static_cast<int32_t>(in_hsic.hue), in_hsic.saturation, in_hsic.intensity,
                          in_hsic.contrast, in_hsic.saturationThreshold}};

    *_aidl_return = controller_->setGlobalPaConfig(&config) == OK;
